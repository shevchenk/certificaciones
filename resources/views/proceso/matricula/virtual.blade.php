...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Matrícula Virtual</li>
    </ol>
</section>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#ModalListapersona" data-filtros="estado:1" data-personaid="ModalMatriculaForm #txt_persona_id"  data-persona="ModalMatriculaForm #txt_persona"  data-dni="ModalMatriculaForm #txt_dni" data-epersona="0" data-buscaralumno="1">Buscar Persona</button>
                                            </span>
                                        </div> 
                                    </div>
                                    <div class="col-md-4">
