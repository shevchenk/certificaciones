...
$(document).ready(function() {
    ...
    $("#FormBandeja .Aprobado").click(()=>{
        ...
        let msj = '<h2 class="alert-success"> Confirmar para actualizar la inscripción y pasar PENDIENTE de revisión a la inscripción </h2>';
...
let Detalle = {
    Visualizar: (id, tipo) => {
        let datos = "nro_pago_inscripcion,monto_pago_inscripcion,nro_pago_matricula,monto_pago_matricula,nro_promocion,monto_promocion";
        ...
        $.each( Matricula, (key, value) => {
            if( tipo == 'Valida' && datos.split(key).length > 1 ){
            ...
            else if( tipo == 'Valida' && tipos.split(key).length > 1 ){
