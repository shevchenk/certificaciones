                        ...
                        <form id="AsignacionForm">
                            <div class="col-sm-12">
                                <div class="col-sm-2 text-center">
                                    <label class="control-label">Fecha Inicial de Aprobado</label>
                                ...
                                <div class="col-sm-2 text-center">
                                    <label class="control-label">Fecha Final de Aprobado</label>
                                    <div class="input-group">
                            ...
                            <div class="table-responsive no-padding col-md-12">
                                <table id="TableVisita" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="background-color: #BDD7EE;color:black; text-align: center;" colspan="3"> DATA </th>
                                        ...
                                        <tr>
                                            <th style="background-color: #BDD7EE;color:black">Cant</th>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <br>
                                    <label class="control-label"><h3>Cantidad de Aprobados Seleccionados:</h3></label>
