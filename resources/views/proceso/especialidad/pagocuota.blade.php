...
@section('include')
    ...
    @include( 'proceso.especialidad.js.pagocuota_ajax' )
    @include( 'proceso.especialidad.js.pagocuota' )
@stop
...
<section class="content">
    ...
    <br/><br/>
    <div class="row">
    <div class="col-xs-12" id="div_pago_cuota" style="display: none;">
        <form id="frm_pago_cuota">
            <div class="box-body table-responsive no-padding">
                ...
                <div class="row" style="padding: 5px 15px; text-align: right; padding-top: 0px;">
                    <input type="button" class="btn btn-default" onClick="btnregresar_curso();" id="btnregresar3" name="" value="Regresar">
                </div>
            </div>
        </form>
    </div>
