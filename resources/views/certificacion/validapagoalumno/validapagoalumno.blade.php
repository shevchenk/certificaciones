...
@include( 'certificacion.validapagoalumno.js.validapagoalumno_ajax' )
@include( 'certificacion.validapagoalumno.js.validapagoalumno' )

@stop

@section('content')
<section class="content-header">
    <h1>Valida Pago del Alumno
        <small>Proceso</small>
    </h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-sitemap"></i> Proceso</li>
        <li class="active">Valida Pago del Alumno</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Procesos - Valida Pago del Alumno</h3>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body table-responsive no-padding">
                                <div class="col-md-12">
                                    <a class="btn btn-success btn-sm" onClick="CambiarEstadoMasivo()"><i class="fa fa-check fa-lg">Iniciar Entrega al Alumno por ODE o Courier Masiva</i></a>
                                </div>
                                <div class="col-md-12">
...
@section('form')
    @include( 'certificacion.validapagoalumno.form.validapagoalumno' )
@stop
