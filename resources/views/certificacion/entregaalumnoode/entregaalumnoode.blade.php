...
@include( 'certificacion.entregaalumnoode.js.entregaalumnoode_ajax' )
@include( 'certificacion.entregaalumnoode.js.entregaalumnoode' )

@stop

@section('content')
<section class="content-header">
    <h1>Entrega al Alumno en ODE
        <small>Proceso</small>
    </h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-sitemap"></i> Proceso</li>
        <li class="active">Entrega al Alumno en ODE</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Procesos - Entrega al Alumno en ODE</h3>
                </div>
...
@section('form')
    @include( 'certificacion.entregaalumnoode.form.entregaalumnoode' )
@stop
