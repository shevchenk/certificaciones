...
@include( 'certificacion.verpagoalumno.js.verpagoalumno_ajax' )
@include( 'certificacion.verpagoalumno.js.verpagoalumno' )
...
@section('form')
    @include( 'certificacion.verpagoalumno.form.verpagoalumno' )
@stop
