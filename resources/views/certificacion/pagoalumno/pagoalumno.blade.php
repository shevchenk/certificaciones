...
@include( 'certificacion.pagoalumno.js.pagoalumno_ajax' )
@include( 'certificacion.pagoalumno.js.pagoalumno' )
...
@section('form')
    @include( 'certificacion.pagoalumno.form.pagoalumno' )
    @include( 'certificacion.pagoalumno.form.archboleta' )
@stop
