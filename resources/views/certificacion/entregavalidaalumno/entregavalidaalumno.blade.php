...
@include( 'certificacion.entregavalidaalumno.js.entregavalidaalumno_ajax' )
@include( 'certificacion.entregavalidaalumno.js.entregavalidaalumno' )

@stop

@section('content')
<section class="content-header">
    <h1>Entrega y Validación del Alumno
        <small>Proceso</small>
    </h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-sitemap"></i> Proceso</li>
        <li class="active">Entrega y Validación del Alumno</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Procesos - Entrega y Validación del Alumno</h3>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body table-responsive no-padding">
                                <div class="col-md-12">
                                    <a class="btn btn-success btn-sm" onClick="CambiarEstadoMasivo()"><i class="fa fa-check fa-lg">Iniciar Entrega y Validación del Alumno Masivo</i></a>
                                </div>
                                <div class="col-md-12">
...
@section('form')
    @include( 'certificacion.entregavalidaalumno.form.entregavalidaalumno' )
@stop
