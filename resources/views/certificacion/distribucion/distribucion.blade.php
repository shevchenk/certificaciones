...
@include( 'certificacion.distribucion.js.distribucion_ajax' )
@include( 'certificacion.distribucion.js.distribucion' )
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Procesos - Distribución</h3>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body table-responsive no-padding">
                                <div class="col-md-12">
                                    <a class="btn btn-success btn-sm" onClick="CambiarEstadoMasivo()"><i class="fa fa-check fa-lg">Iniciar Recepción en ODE Masivo</i></a>
                                </div>
                                <div class="col-md-12">
...
@stop
@section('form')
    @include( 'certificacion.distribucion.form.distribucion' )
@stop