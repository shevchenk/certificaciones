...
@include( 'certificacion.verentregavalidaalumno.js.verentregavalidaalumno_ajax' )
@include( 'certificacion.verentregavalidaalumno.js.verentregavalidaalumno' )
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Calidad del Servicio</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Procesos - Calidad del Servicio</h3>
                </div>
...
@section('form')
    @include( 'certificacion.verentregavalidaalumno.form.verentregavalidaalumno' )
@stop
