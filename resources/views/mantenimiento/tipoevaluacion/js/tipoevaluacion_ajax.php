...
var AjaxTipoEvaluacion={
    AgregarEditar:function(evento){
        ...
        url='AjaxDinamic/Mantenimiento.TipoEvaluacionMA@New';
        if(AddEdit==0){
            url='AjaxDinamic/Mantenimiento.TipoEvaluacionMA@Edit';
        }
    ...
    Cargar:function(evento,pag){
        ...
        url='AjaxDinamic/Mantenimiento.TipoEvaluacionMA@Load';
        masterG.postAjax(url,data,evento);
    },
    CambiarEstado:function(evento,AI,id){
        ...
        url='AjaxDinamic/Mantenimiento.TipoEvaluacionMA@EditStatus';
        masterG.postAjax(url,data,evento);
    },
};
</script>
