...
$(document).ready(function() {
    ...
    $("#ListadocenteForm #TableListadocente select").change(function(){ AjaxListadocente.Listar(HTMLCargarDocente); });
    $("#ListadocenteForm #TableListadocente input").blur(function(){ AjaxListadocente.Listar(HTMLCargarDocente); });
    ...
    $('#ModalListadocente').on('shown.bs.modal', function (event) { 
      ...
      AjaxListadocente.Listar(HTMLCargarDocente);
