                ...
                <form id="ModalArchivoForm">
                    ...
                    <div class="col-md-6 col-sm-12">
                      <div class="col-md-6">
                        ...
                        <input type="text" style="display: none;" id="txt_diapo_archivo" name="txt_diapo_archivo">
                        <label class="btn btn-default btn-flat margin btn-xs">
                            <i class="fa fa-file-image-o fa-3x"></i>
                            <i class="fa fa-file-pdf-o fa-3x"></i>
                            <i class="fa fa-file-word-o fa-3x"></i>
                            <input type="file" class="mant" style="display: none;" onchange="masterG.onImagen(event,'#txt_diapo_nombre','#txt_diapo_archivo','#diapo_img');" >
                        </label>
                      </div>
                      <div class="col-md-4 col-sm-6">
                        <a id="diapo_href">
