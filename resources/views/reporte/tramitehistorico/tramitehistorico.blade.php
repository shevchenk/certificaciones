...
@include( 'reporte.tramitehistorico.js.tramitehistorico_ajax' )
@include( 'reporte.tramitehistorico.js.tramitehistorico' )
@stop
...
<style>
    ...
    <section class="content-header">
        <h1>Tramites Historicos
            <small>Reporte</small>
        </h1>
        <ol class="breadcrumb">
            <li><i class="fa fa-sitemap"></i> Reportes</li>
            <li class="active">Tramites Historicos</li>
        </ol>
    </section>
