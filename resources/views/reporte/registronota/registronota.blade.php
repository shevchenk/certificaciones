...
@include( 'reporte.registronota.js.registronota_ajax' )
@include( 'reporte.registronota.js.registronota' )
@stop
                                ...
                                <table id="TableReporte" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th id="notacurso" style="background-color: #FFF2CC;" colspan='5'>NOTA DEL CURSO</th>
                                        </tr>
                                        <tr id="cabecera">
                                            ...
                                            <th class="cabecera" style="background-color: #FFF2CC;">N1</th>
                                            <th class="cabecera" style="background-color: #FFF2CC;">N2</th>
                                            <th class="cabecera" style="background-color: #FFF2CC;">N3</th>
                                            <th class="cabecera" style="background-color: #FFF2CC;">N4</th>
                                            <th class="cabecera" style="background-color: #FFF2CC;">Promedio Final</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
