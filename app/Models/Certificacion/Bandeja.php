...
class Bandeja extends Model
{
    ...
    public static function runLoadValidaPagoAlumno($r)
    {
        $sql=DB::table('alumnos AS a')
            ->join('certificados AS c',function($join){
                $join->on('c.alumno_id','=','a.id')
    ...
    public static function runLoadEntregaCourierAlumno($r)
    {
        $sql=DB::table('alumnos AS a')
            ->join('certificados AS c',function($join){
                $join->on('c.alumno_id','=','a.id')
    ...
    public static function runLoadEntregaAlumnoODE($r)
    {
        $sql=DB::table('alumnos AS a')
            ->join('certificados AS c',function($join){
                $join->on('c.alumno_id','=','a.id')
    ...
    public static function runLoadEntregaValidaAlumno($r)
    {
        $sql=DB::table('alumnos AS a')
            ->join('certificados AS c',function($join){
                $join->on('c.alumno_id','=','a.id')
    ...
    public static function runLoadPagoAlumno($r)
    {
        $sql=DB::table('alumnos AS a')
            ->join('certificados AS c',function($join){
                $join->on('c.alumno_id','=','a.id')
